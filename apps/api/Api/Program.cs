...
builder.Services.AddCors(o => o.AddPolicy("app",p  =>
    p.WithOrigins("https://door-meen.vercel.app" ,"https://door-meen-kdtlthfce-awsaqhs-projects.vercel.app", "http://localhost:5173" , "http://localhost:3000").AllowAnyHeader().AllowAnyMethod()));
